...
## Project Structure
    ...
    ├── testapiautosettings_54723  # Django project configurations
...
1. Clone this repo and `cd testapiautosettings_54723`
...
2. Clone this repo and `cd testapiautosettings_54723`
